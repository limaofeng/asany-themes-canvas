...
function Header(){
    return <header id="header" className="full-header">
    <div id="header-wrap">
        <div className="container">
            <div className="header-row">
                    ...
                    <ul className="menu-container">
                        <li className="menu-item">
                            ...
                            <ul className="sub-menu-container">
                                <li className="menu-item">
                                    <a className="menu-link" href="intro.html#section-niche" data-scrollto="#section-niche"><div>Niche Demos</div></a>
                                </li>
                                <li className="menu-item">
                                    <a className="menu-link" href="intro.html#section-onepage" data-scrollto="#section-onepage"><div>One-Page Demos</div></a>
                                </li>
                                <li className="menu-item">
                ...
                <form className="top-search-form" action="search.html" method="get">
                    <input type="text" name="q" className="form-control" value="" placeholder="Type &amp; Hit Enter.." autoComplete="off"/>
                </form>
            </div>
        </div>
    </div>
